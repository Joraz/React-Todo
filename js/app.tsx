...
let TodoModel = app.models.TodoModel;
let TodoFooter = app.components.TodoFooter;
let TodoItem = app.components.TodoItem;
...
namespace app.components
{
	export class TodoApp extends React.Component<IAppProps, IAppState>
	{
		...
		public handleNewTodoKeyDown(event: React.KeyboardEvent)
		{
			...
			let val = React.findDOMNode<HTMLInputElement>(this.refs["newField"]).value.trim();
